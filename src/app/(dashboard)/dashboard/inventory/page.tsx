  ...
  return (
    <div className="p-8 flex flex-col gap-6 pb-0">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-[32px] font-bold text-[#191c1e] tracking-[-0.64px] leading-10">Inventory</h1>
          <p className="text-[#434655] text-base mt-1">Manage your stock levels and product catalogue.</p>
        </div>
        <button
          type="button"
      ...
      <div className="bg-white border border-[#c3c6d7] rounded-xl p-12 text-center text-[#434655]">
        <p className="font-semibold text-[#141b2b] text-lg mb-1">No inventory items</p>
        <p className="text-sm">Add products to start tracking your stock.</p>
      </div>
